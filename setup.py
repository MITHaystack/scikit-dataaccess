...
setup(name     = package_name,
      ...
      package_data={'skdaccess': [
          ...
          'examples/Demo_Kepler_LightCurves_AllExoplanets_PDCSAP.ipynb',
          'examples/Demo_Kepler_LightCurves_AllExoplanets_PDCSAP_RelativeFlux.ipynb',
